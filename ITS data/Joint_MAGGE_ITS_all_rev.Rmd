...
Magge_joint_ITS <- readRDS("C:/Users/bogda/Documents/PhD/MAGGE/Finals/MAGGE_new_ITS_physeq.rds")
#
#/Volumes/micro-shared$/MoralesLab/Manuscripts/Magge-pH combined microbiome/ITS/MAGGE_new_ITS_physeq.rds
#sample_data(Magge_joint_ITS)$Country_code <- substr(sample_data(Magge_joint_ITS)$Country, 1, 2)
